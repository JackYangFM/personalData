        ...
        <div class="page">
          ...
          <div class="content">
            <div class="user">
              ...
              <div class="tile ani" swiper-animate-effect="fadeInRight" swiper-animate-duration="1s" swiper-animate-delay="0.2s">你还记得吗</div>
            </div>
            ...
            <div class="info">
              <div class="header ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.4s">你拥有了</div>
              ...
              <div class="footer ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.6s">那是我们的初次相遇</div>
            </div>
            <div class="duration ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.7s">
              至今，已相伴走过 <span>{{duration}}</span> 个月
            </div>
          </div>
          <div class="devices">
      ...
      <div class="section page-2">
        ...
        <div class="page">
          ...
          <div class="content">
            <div class="wrapper">
              <div class="header">
                <div class="title ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.1s">每一条骑过的路，都值得被记录</div>
                <div class="sub-title ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.2s">2018年累计骑行</div>
              </div>
              <div class="body">
                <div class="data">
                  <div class="date ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.3s"><span class="ani" swiper-animate-effect="flipInX" swiper-animate-duration="1s" swiper-animate-delay="0.5s">{{data.riding_day}}</span>天</div>
                  <div class="mile ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.4s"><span class="ani" swiper-animate-effect="flipInX" swiper-animate-duration="1s" swiper-animate-delay="0.5s">{{data.riding_kilometre}}</span>千米</div>
                </div>
                <div class="energy">
                  <div class="carbon ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.5s">相当于减少碳排放 <span>{{data.carbon_emission}} </span></div>
                  <div class="ranking ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.6s">领先全球 <span>{{data.lead_percentage}}%</span> 的N星人</div>
                </div>
              </div>
              <div class="footer">
                <div class="title ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.7s">
                  <span>{{parseTime(data.highest_time, '{m}月{d}日')}}，</span>你行驶了 <span>{{data.highest_mileage}}千米</span>
                </div>
          ...
          <div class="bottom">
            <div class="title ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.8s">
              <span>{{parseTime(data.latest_time, '{m}月{d}日')}}， {{parseTime(data.latest_time, '{h} : {i}')}}</span> 还在骑车
            </div>
            ...
            <div class="wrapper">
              <div v-if="data.first_cricle_content !== ''" class="post">
                ...
                <div class="body">
                  ...
                  <div class="comment">
                    <div class="top ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.4s">之后收到 <span>{{data.first_cricle_fabulous}}</span> 的第一个赞</div>
                    <div class="bottom ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.5s">你感兴趣的第一个人是 <span>{{data.first_follow}}</span></div>
                  </div>
                </div>
                <div class="footer ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.6s">好骑友，别忘了常联系</div>
              </div>
              <div v-else class="no-post">
                <div class="no-data">
                  <div class="msg ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0s">学车时艰难的心路历程</div>
                  <div class="msg ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.1s">成功骑行那一刻的喜悦与自豪</div>
                  <div class="msg ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.2s">穿过数不清的大街小巷</div>
                  <div class="msg ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.3s">途中令你印象深刻的人或事</div>
                  <div class="msg ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.4s">……</div>
                </div>
                <div class="tips">
                  <div class="tip ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.5s">别让这些记忆深藏在心底</div>
                  <div class="tip ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.6s">去N粉圈跟骑友一起分享吧</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="section page-5">
        ...
        <div class="page">
          <div class="content">
            ...
            <div class="wrapper">
              <div class="header">
                <div class="title ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0s">恭喜你</div>
                <div class="sub-title ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.1s">获得2018年荣誉称号</div>
              </div>
              <div class="body">
              ...
              <div class="footer">
                <div class="thanks ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.3s">感谢</div>
                <div class="com ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.4s">与我们一起经历2018年的你</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="wrapper">
                ...
                <div class="playground">
                  ...
                  <transition name="gift-transition" enter-active-class="animated bounceInDown" leave-active-class="animated fadeOut">
                    <div class="container after" v-if="giftStatus">
                      <div class="m-header">恭喜获得</div>
                      <div class="m-body">
                        <div class="icon">
                          <img data-load v-if="gift.type === 2" src="./ncoin.png">
                          <img data-load v-if="gift.type === 1" src="./medal.png">
                        </div>
                        <div v-if="gift.type === 2" class="data"><span>{{gift.data}}</span>N币</div>
                        <div v-if="gift.type === 1" class="data">{{gift.data.title}}</div>
                      </div>
                      <div class="m-footer">奖品会在48小时内发放到你的账户</div>
                    </div>
                  </transition>
                </div>
                <div class="tip">
                  您有 <span>{{data.luck_draw_times}}</span> 次抽奖机会
                </div>
                <div class="oper">
              ...
              <div class="footer">
                ...
                <div class="company ani" swiper-animate-effect="fadeIn" swiper-animate-duration="1s" swiper-animate-delay="0.4s">
                  ...
                  <div class="tip">
                    <div class="legal" @click="handlerLegal">*数据统计说明</div>
                  </div>
                </div>
              </div>
            </div>
